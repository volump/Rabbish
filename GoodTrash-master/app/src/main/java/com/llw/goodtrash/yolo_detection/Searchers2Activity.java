package com.llw.goodtrash.yolo_detection;
...
//import io.reactivex.annotations.NonNull;erd
...
public class Searchers2Activity extends Activity implements View.OnClickListener, CameraSurfaceView.OnTextureChangedListener {
    private static final String TAG = Searchers2Activity.class.getSimpleName();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_shutter:
                ...
                Toast.makeText(Searchers2Activity.this, "Save snapshot to " + savedImagePath, Toast.LENGTH_SHORT).show();
                break;
            case R.id.btn_settings:
                startActivity(new Intent(Searchers2Activity.this, Settings2Activity.class));
                break;
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (grantResults[0] != PackageManager.PERMISSION_GRANTED || grantResults[1] != PackageManager.PERMISSION_GRANTED) {
            new AlertDialog.Builder(Searchers2Activity.this)
                    ...
                    .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Searchers2Activity.this.finish();
                        }
                    }).show();
        }
    }

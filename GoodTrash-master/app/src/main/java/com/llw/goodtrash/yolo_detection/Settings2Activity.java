...
import com.llw.goodtrash.common.AppCompatPreferenceActivity;
...
public class Settings2Activity extends AppCompatPreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static boolean checkAndUpdateSettings(Context ctx) {

 ...
 * @author llw
 */
public class Main_2Activity extends MvpActivity<MainContract.MainPresenter> implements MainContract.MainView {

    private static final String TAG = "Main_2Activity";
    //轮播
    ...
    private void gotoActivity(Class<?> clazz) {
        startActivity(new Intent(Main_2Activity.this, clazz));
    }

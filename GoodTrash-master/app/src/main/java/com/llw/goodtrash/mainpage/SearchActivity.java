...
public class SearchActivity extends MvpActivity<MainContract.MainPresenter> implements MainContract.MainView {
...
//        gotoActivity(SearchersActivity.class);
//    }
    public void jumpImageInput(View view) {
    ...
    private void gotoActivity(Class<?> clazz) {
        startActivity(new Intent(SearchActivity.this, clazz));
    }
